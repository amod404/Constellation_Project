...
question_list = ["question1.png", "question2.png","question3.png","question4.png","question5.png","question6.png"]
answer_list = ["answer1.png", "answer2.png", "answer3.png", "answer4.png", "answer5.png", "answer6.png"]
...
def resample_points(points, num_points=50):
    ...
    # If zero distance anywhere, interpolation will break
    if np.any(dists == 0):
    ...
    try:
        ...
        if a:
            if mode == 1:
                ...
                # target_points = resample_points(np.load(TARGET), 50)
                # user_points = resample_points(np.array(a), 50)

                # target_vec = target_points.flatten().reshape(1, -1)
                # user_vec = user_points.flatten().reshape(1, -1)

                # accuracy = cosine_similarity(target_vec, user_vec)[0][0]  # 0 to 1
                # print("Cosine similarity accuracy:", accuracy)
